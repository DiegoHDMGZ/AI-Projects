...
var sndClick = new Howl({ src: ['snd/alert.mp3'] });
let isPlaying = false;
sndClick.on('end', function(){
  isPlaying = false;
});
...
function takeSnapshot() {
  ...
  var width = parseInt(video.videoWidth/4, 10);
  var height = parseInt(video.videoHeight/4, 10);
